...
<form class="theme-form-one form-validation" autocomplete="off">
  <div class="form-row">
    <div class="form-group col-md-6">
      <label for="itemFound">Item Found</label>
      <input type="text" class="form-control" id="itemFound" placeholder="sweater">
    </div>
    <div class="form-group col-md-6">
      <label for="dat">Date Found</label>
    ...
    <div class="form-group col-md-6">
      <label for="where">Where Found</label>
